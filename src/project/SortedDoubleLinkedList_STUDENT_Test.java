...
public class SortedDoubleLinkedList_STUDENT_Test {
	...
	public Car a=new Car("Ford", "Escape", 2012);
	public Car b=new Car("Hyundai", "Sonata", 2012);
	public Car c=new Car("Honda", "Accord", 2012);
	public Car d=new Car("Infinity", "Q50", 2012);
	public Car e=new Car("Chevrolet", "Colorado", 2012);
	public Car f=new Car("Cadillac", "Escalade", 2012);
	...
	public void testAddToEnd() {
		try {
			sortedLinkedString.addToEnd("Amigo");
	...
	public void testAddToFront() {
		try {
			sortedLinkedString.addToFront("Amigo");
			assertTrue("Did not throw an UnsupportedOperationException", false);
		}
		catch (UnsupportedOperationException e)
		{
	...
	public void testIteratorSuccessfulStringPrevious() {
		sortedLinkedString.add("Bread");
		sortedLinkedString.add("Chief");
		sortedLinkedString.add("Hallo");
		sortedLinkedString.add("Zebra");
		ListIterator<String> iterator = sortedLinkedString.iterator();
		assertEquals(true, iterator.hasNext());
		assertEquals("Bread", iterator.next());
		assertEquals("Chief", iterator.next());
		assertEquals("Hallo", iterator.next());
		assertEquals("Zebra", iterator.next());
		assertEquals(true, iterator.hasPrevious());
		assertEquals("Zebra", iterator.previous());
		assertEquals("Hallo", iterator.previous());
		assertEquals("Chief", iterator.previous());
	}
	@Test
