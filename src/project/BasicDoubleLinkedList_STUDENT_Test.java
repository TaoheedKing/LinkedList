...
import project.SortedDoubleLinkedList_STUDENT_Test.Car;
...
public class BasicDoubleLinkedList_STUDENT_Test {
	...
	public void testAddToEnd() {
		assertEquals("Humans", linkedString.getLast());
	...
	public void testAddToFront() {
		assertEquals("Howdy", linkedString.getFirst());
	...
	public void testIteratorSuccessfulNext() {
		...
		assertEquals("Humans", iterator.next());
		assertEquals(true, iterator.hasNext());
	...
	public void testRetrieveFirstElement() {
		...
		assertEquals("Howdy",linkedString.getFirst());
		assertEquals("Howdy", linkedString.retrieveFirstElement());
		assertEquals("Humans",linkedString.getFirst());
